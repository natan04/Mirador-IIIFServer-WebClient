#include "stdafx.h"
#include "ProfileSeamTextLineExtractor.h"
#include "DImage.h"
#include "ProjectionProfile.h"
#include <math.h>


ProfileSeamTextLineExtractor::ProfileSeamTextLineExtractor(ProjectionProfile proj, DImage* prof,Mat img) {
...
std::vector<DImage> ProfileSeamTextLineExtractor::createVerticalDevision(int k, int projectionMethod) {
...
void ProfileSeamTextLineExtractor::MedialSeamDrawing(){
...
//==========================================================================================
vector<vector<int>> ProfileSeamTextLineExtractor::computeSeperatingSeams(){
...
//================================================================================================================
void ProfileSeamTextLineExtractor::extract(){
