...
class GaborBlobExtractor : public FeatureExtractor {
	int   _numOrientation ;
...
public:
	...
	GaborBlobExtractor(int n, int r, double sigma, double lambda, double aspect_ratio){
		_numOrientation = n ;
	...
	GaborBlobFeature* getComponentFeature(ConnectedComponent* component); 
