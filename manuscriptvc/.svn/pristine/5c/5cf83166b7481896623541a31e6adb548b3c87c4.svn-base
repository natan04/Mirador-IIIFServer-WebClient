...
class ExtractorGSC : public FeatureExtractor {
...
public:
	...
	ExtractorGSC(double gradientConstant, double structuralConstant, double concavityConstant) {
		init(DEFAULT_IMAGE_DIMENSIONS, DEFAULT_IMAGE_DIMENSIONS, gradientConstant, structuralConstant, concavityConstant);
	}

	ExtractorGSC(int numOfColumns, int numOfRows, double gradientConstant, double structuralConstant, double concavityConstant) {
