...
//==========================================================================
DImage* AnisotropicFilter::filter(){
	
	Mat M = findMaxResponse();
	M = eraseMargins(M);
	DImage* res = new DImage(M);
...
//=============================================================
Mat AnisotropicFilter::eraseMargins(Mat im){
...
//================================================================================
vector<double> AnisotropicFilter::wordSizeEstimation() {
...
//===============================================================
Mat AnisotropicFilter::findMaxResponse(){
...
//===================================================================
Mat AnisotropicFilter::applyFilter(double* I, Size sz, double theta, double scale, double eta){
