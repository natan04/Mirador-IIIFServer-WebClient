#include "stdafx.h"
#include "ExtractorGSC.h"

void ExtractorGSC::extract(vector<Feature*>& list) {
	...
	FeatureGSC* feature = new FeatureGSC(gradientVector, structuralVector, densityVector, strokeVector, concavityVector, featureDataSize);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::init(int numOfColumns, int numOfRows, double gradientConstant, double structuralConstant, double concavityConstant) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::concavityExtraction(vector<uchar>& concavityVector) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::largeStrokeExtraction(vector<uchar>& strokeVector) {
	double concavityThreshold = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::densityExtraction(vector<bool>& densityVector) {
	double concavityThreshold = 0;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::structuralExtraction(vector<Mat>& angles, vector<ushort>& structuralVector) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::gradientsExtraction(vector<Mat>& angles, vector<ushort>& gradientVector) {
...
/// <remarks> Shay Yacobinski </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::calculateHorizontalSeperators() {
...
/// <remarks> Shay Yacobinski </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::calculateVerticalSeperators() {
	// Get the width, height and mid point of the src image
	int cols_num = _image.cols;
	int rows_num = _image.rows;
...
/// <remarks> Shay Yacobinski </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::calculateImageSeperators() {
	/* Horizontal */
...
/// <remarks> Shay Yacobinski </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::buildImageGrid() {
	int regionIndex = 0;
...
/// <param name="strokeVector"> Large stroke feature vector </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::discoverHorizontalStroke(double concavityThreshold, Mat& regionMat, int regionIndex, vector<uchar>& strokeVector) {
	int horizonLength = 0;
...
/// <param name="strokeVector"> Large stroke feature vector </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::discoverVerticalStroke(double concavityThreshold, Mat& regionMat, int regionIndex, vector<uchar>& strokeVector) {
...
/// <param name="concavityVector"> Concavity feature vector </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
void ExtractorGSC::convolveRegion(double concavityThreshold, int fromRow, int fromColumn, int toRow, int toColumn, int reg_index, vector<uchar>& concavityVector) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachRight(int row, int col) {
...
/// <param name="col"> The column of the background pixels </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachLeft(int row, int col) {
...
/// <param name="col"> The column of the background pixels </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachUp(int row, int col) {
...
/// <param name="col"> The column of the background pixels </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachDown(int row, int col) {
...
/// <param name="col"> The column of the background pixels </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachUpRight(int row, int col) {
	int i = row - 1;
	int j = col + 1;
...
/// <param name="col"> The column of the background pixels </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachDownRight(int row, int col) {
	int i = row + 1;
	int j = col + 1;
...
/// <param name="col"> The column of the background pixels </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachUpLeft(int row, int col) {
	int i = row - 1;
	int j = col - 1;
...
/// <param name="col"> The column of the background pixels </param>
////////////////////////////////////////////////////////////////////////////////////////////////////
bool ExtractorGSC::reachDownLeft(int row, int col) {
	int i = row + 1;
	int j = col - 1;
