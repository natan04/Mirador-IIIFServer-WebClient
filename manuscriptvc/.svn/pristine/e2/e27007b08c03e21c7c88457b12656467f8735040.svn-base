...
class FeatureGSC : public Feature {
...
public:
	...
	FeatureGSC(vector<ushort> gradientVector, vector<ushort> structuralVector, vector<bool> densityVector, vector<uchar> strokeVector, vector<uchar> concavityVector, size_t featureVecSize) {
