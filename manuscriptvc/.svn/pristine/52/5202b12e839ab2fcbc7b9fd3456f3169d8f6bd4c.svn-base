...
FeatureGaborBlob* ExtractorGaborBlob::getComponentFeature(ConnectedComponent* component){
...
Mat ExtractorGaborBlob::featureVisualizationImage(Size size, vector<Feature*>& list){
...
void ExtractorGaborBlob::processResponse(DImage& response, float angle, vector<Feature*>& list){
...
Mat ExtractorGaborBlob::extractBlobFromResponse(DImage& response, Contour& contour){
...
void ExtractorGaborBlob::generateOrientationList(){
...
Mat  ExtractorGaborBlob::computeGaborResponse(float orientation){
	double min, max ;
...
void ExtractorGaborBlob::extract(vector<Feature*>& list){
	float orientationStep = 180.0f/_numOrientation ;
	float orientation = 0 ; 
	for ( int i = 0 ; i < _numOrientation ; i++ ){
