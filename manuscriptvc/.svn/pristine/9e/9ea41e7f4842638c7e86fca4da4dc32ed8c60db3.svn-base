...
void FeatureGaborBlob::setSamples(Mat& samples){
	int idx = 0 ;
...
vector<float> FeatureGaborBlob::vectorize() {
	vector<float> array ;
...
void FeatureGaborBlob::sample2Row(Mat samples, int row){
	Point2f com =  _org + _contour.getCenter() ;
...
double FeatureGaborBlob::distance(Feature* a){
	return 0 ;
}
