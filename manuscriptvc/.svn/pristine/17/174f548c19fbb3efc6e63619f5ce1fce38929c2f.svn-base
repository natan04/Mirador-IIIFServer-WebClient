...
vector<bool>& GSCFeature::getFeatureVector() {
...
vector<bool>& GSCFeature::getFeatureVector(int size) {
...
vector<ushort>& GSCFeature::getGradientVector() {
	return _gradientVector;
}

vector<ushort>& GSCFeature::getStructuralVector() {
	return _structuralVector;
}

vector<bool>& GSCFeature::getDensityVector() {
	return _densityVector;
}

vector<uchar>& GSCFeature::getStrokeVector() {
	return _strokeVector;
}

vector<uchar>& GSCFeature::getConcavityVector() {
	return _strokeVector;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GSCFeature::buildFeatureVector() {
...
void GSCFeature::sample2Row(Mat samples, int row) {

}

double GSCFeature::distance(Feature* a){
	return 0;
}

vector<float> GSCFeature::vectorize() {
	vector<float> array;
	return array;
}